...
def memorygallery(request):
        image_data = [
        ("/static/images/imagesForMemoryHome/Firstone_11zon.jpg", "This song signifies the new that we looking ahead when we just arrived at the spsu for the first time. I dont know what is cse but i am doing it. I only knew names of these 3 people whom i dont really know","/static/audio/give_me_some_sunshine_trimmed2.mp3"),
        ("/static/images/imagesForMemoryHome/Second_11zon.jpg", "Badne do yaari ka circle jaara happy happy sa har pal jara, new friendship new word. I still remember teeno ne is baat pe meeting ki thi ki mujhe wiered na lage isliye sab dhyan rakhe", "/static/audio/ye_no_oneYaari_trimmed.mp3"),
        ("/static/images/imagesForMemoryHome/third_11zon.jpg", "Yaado ke purane album me, i still hold of these photos. These were good times i always missed. But its okay now. Sunset is beatiful isnt it?","/static/audio/woh_din_bhi_kya_din_the_trimmed.mp3"),
        ("/static/images/imagesForMemoryHome/fourth_11zon.jpg", "I dont think you people will understand this song 😂. It feels like we are gang of four members at that time. Who seek to fight except me offcourse.", "/static/audio/tora_friendship_trimmed.mp3"), 
        ("/static/images/imagesForMemoryHome/fifth_11zon.jpg", "Well well well dimonds are tough. so strong, like i give a shit about it. I know my friends will be corepati so i will take loan from them and buy a lot of dimonds 🤑","/static/audio/yaro_mere_waste_trimmed.mp3"),
